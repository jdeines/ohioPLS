...
spatialDist<- ecodist::distance(centroids[,2:3], method = "euclidean")

PLS_space <- mantel(PLSdist ~ spatialDist, nperm=10000)
FIA_space <- mantel(FIAdist ~ spatialDist, nperm=10000)
...
PLS_env_space <- mantel(PLSdist ~ envirDist + spatialDist, nperm=10000)
FIA_env_space <- mantel(FIAdist ~ envirDist + spatialDist, nperm=10000)

mantel(FIAdist ~ spatialDist + envirDist, nperm=10000)
mantel(PLSdist ~ spatialDist + envirDist, nperm=10000)

PLS_lu_space <- mantel(PLSdist ~ luDist + spatialDist, nperm=10000)
FIA_lu_space <- mantel(FIAdist ~ luDist + spatialDist, nperm=10000)
```
