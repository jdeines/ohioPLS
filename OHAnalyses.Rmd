...
```{r NMDS, fig.width=9, fig.height=5}
setwd('C:/Users/deinesji/Dropbox/Dan_Williams/CleanCodeAndData')
...
par(mar=c(5,4,2,1))
plot(PLS.nmds.min, main='Settlement-Era', col=pls$color, pch=16)
plot(PLS.nmds.vf)
legend('bottomleft', legend=paste0('r^2 = ',round(max(PLSnmds$r2),2)), bty='n')  

par(mar=c(5,4,2,1))
plot(FIA.nmds.min, main='Modern', col=pls$color, pch=16)
plot(FIA.nmds.vf)
legend('bottomright', legend=paste0('r^2 = ',round(max(FIAnmds$r2),2)), bty='n') 
