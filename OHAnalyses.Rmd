...
par(mar=c(5,4,2,1))
plot(PLS.nmds.min, main='Settlement-Era', col='black', pch=pls$pch, xlim=xrange, ylim=yrange)
plot(PLS.nmds.vf)
legend('topleft', legend=paste0('r^2 = ',round(max(PLSnmds$r2),2)), bty='n')  

par(mar=c(5,4,2,1))
plot(FIA.nmds.min, main='Modern', col='black', pch=pls$pch, xlim=xrange, ylim=yrange)
plot(FIA.nmds.vf)
...
legend("bottom", legend=c('southeast counties','northwest counties'), pch=c(25,3), bty='n')
