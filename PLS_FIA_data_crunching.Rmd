...
FIA.spec2 <-cbind(FIA.spec1[,c("id","County")],
	...
	"other"=rowSums(FIA.spec1[,c("chestnut","eastern.red.cedar","norway.spruce","blue.spruce",
                  "eastern.hemlock","ohio.buckeye","yellow.buckeye",
...
#png("exportedFigs/SpeciesChangeWorking_NewScheme_noBg.png", type = "cairo", units = "in", width = 7, height = 5, res = 2000)
...
# labels[8] <- 'honey locust'
# spplot(change3[,14:28],col.regions=colchange, col='gray29', names.attr=labels, 
#        at=seq(-55,55,(55+55)/13), as.table=T, 
#        colorkey=list(labels=list(cex=1.2)), 
#        par.settings = list(panel.background=list(col="gray96"),
#                              layout.widths=list(right.padding=6)))
# grid.text("Change in Relative Abundance (%)", x=unit(0.95, "npc"), y=unit(0.50, "npc"), rot=-90)
...
labels <- names(change3[,14:28])
labels[8] <- 'honey locust'
colchange <- c("#a50026","#d73027","#f46d43","#fdae61","#fed569","#ffffbf","#abd9e9",
               "#92c5de","#74add1","#4575b4","#313695")
